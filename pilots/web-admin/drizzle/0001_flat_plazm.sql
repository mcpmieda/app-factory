...
--> statement-breakpoint
INSERT INTO `__new_items`("id", "name", "category", "status", "location", "notes", "active", "created_at", "updated_at") SELECT "id", "name", "category", "status", "location", "notes", "active", "created_at", "updated_at" FROM `items`;--> statement-breakpoint
