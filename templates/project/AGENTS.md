...
10. For semantic work, follow App Factory `core/SEMANTIC_ASSURANCE.md` + `core/SEMANTIC_VERIFICATION.md`. Use proportional semantic depth and keep project-specific semantic artifacts recoverable when required.
